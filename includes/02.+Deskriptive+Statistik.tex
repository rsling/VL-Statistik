...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item Bei unendlich vielen Messungen
      ...
      \end{itemize}
     \Zeile 
    \item \gruen{Standardfehler} | Standardabweichung der Messwerte
      \begin{itemize}[<+->]
...
\begin{frame}
  ...
  \end{math}\\
  \Zeile 
  \footnotesize \orongsch{$x$} ist der Wert, für den die Funktion die Wahrscheinlichkeit angibt. Der \grau{graue Term}\\
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item \grau{\footnotesize Achtung: Dieser z-Wert ist nicht ganz dasselbe wie der rein deskriptive z-Wert von Folie~\ref{slide:z}}
      \Zeile
