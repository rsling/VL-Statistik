...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item \alert{Ein Maß für Zentraltendenz} für \orongsch{beliebig viele Verteilungsformen}
      \Halbzeile
    \item Arithmetisches Mittel | besonders \orongsch{schlecht sensitiv für Verteilungform}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item \alert{\texttt{qnorm(0.025, lower.tail=FALSE)}} \ding{222} \orongsch{$z = 1.96$}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item 95\% der Werte | \orongsch{Wahrer Anteilswert ± Konfidenzbreite}
  \end{itemize}
  \Doppelzeile
  \begin{center}
...
\begin{frame}
  ...
  \begin{itemize}[<+->]
    ...
    \item Vor allem: Wir sind \rot{\textbf{\ul{nicht}} zu 95\% sicher, dass \ldots\ !!!}
  \end{itemize}
\end{frame}
