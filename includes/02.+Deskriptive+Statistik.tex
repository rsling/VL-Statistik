...
\begin{frame}
  ...
  \vspace{-2cm}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{mode}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}[!h]{cc}
      \vspace{1.5cm} & \multirow{3}{*}{\includegraphics[width=0.5\textwidth,angle=90]{mean}} \\
...
\begin{frame}
  ...
  Kontinuierliche Variablen und ihr arithmetisches Mittel lassen sich in \alert{Dichteplots} gut visualisieren (per Software).
    \vspace{-2cm}
  \begin{center}
    \includegraphics[width=0.7\textwidth,angle=90]{meandens}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \vspace{-0.5cm}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{fourdists}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \vspace{-0.5cm}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{fourquartile}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.5\textwidth]{boxplotpdf}\\
...
\begin{frame}
  ...
  \vspace{-0.5cm}
  \begin{center}
    \includegraphics[width=0.5\textwidth]{fourbox}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \vspace{-2cm}
  \begin{center}
    \includegraphics[width=0.7\textwidth,angle=90]{stdevs}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \vspace{-0.5cm}
  \begin{center}
    \includegraphics[width=0.4\textwidth]{corrplot}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.4\textwidth]{cov01}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.4\textwidth]{cov02}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.4\textwidth]{cov03}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.4\textwidth]{cov04}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  $cov(x,y)=34.52$
  \begin{center}
    \includegraphics[width=0.4\textwidth]{cov05}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.4\textwidth]{cov06}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=0.4\textwidth]{cov07}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  $cov(x,y)=-33.77$
  \begin{center}
    \includegraphics[width=0.4\textwidth]{cov08}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \vspace{-1cm}
  \begin{center}
    \includegraphics[width=0.4\textwidth]{cov09}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \vspace{-1cm}
  \begin{center}
    \includegraphics[width=0.7\textwidth,angle=90]{ki}
  \end{center}
\end{frame}
