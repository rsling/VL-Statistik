...
\begin{frame}
  ...
  \begin{center}
    \begin{tabular}[h!]{ccccc}
      \multirow{3}{*}{\includegraphics[width=0.2\textwidth]{anova_var_total}} & \multirow{3}{*}{$=$} & \multirow{3}{*}{\includegraphics[width=0.2\textwidth]{anova_var_between}} & \multirow{3}{*}{$+$} & \includegraphics[width=0.15\textwidth]{anova_var_x1} \\
...
\begin{frame}
  ...
  \begin{center}
    \alert{$F=\frac{\mathsf{Varianz\ zwischen\ Stichprobenmitteln}}{\mathsf{Varianz\ in\ den\ Stichproben}}=\frac{\mathsf{Varianz\ zwischen\ Stichprobenmitteln}}{\mathsf{Varianz\ per\ Zufall}}$}\\
    \begin{tabular}[h!]{cc}
      \multirow{2}{*}{$F=$} & \includegraphics[width=0.2\textwidth]{anova_var_between} \\\cline{2-2}
      & \includegraphics[width=0.2\textwidth]{anova_var_x1}\ \raisebox{1.25cm}{+}\ \includegraphics[width=0.2\textwidth]{anova_var_x2}\ \raisebox{1.25cm}{+}\ \includegraphics[width=0.2\textwidth]{anova_var_x3} \\
    \end{tabular}\\
    \Zeile
    \rot{Wenn man den Abstand zwischen den Mitteln verschiebt,\\\textbf{muss} die Gesamtvarianz größer werden!}
  \end{center}
