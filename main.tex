...
\ifdefined\TITLE
  \date[\StrSubstitute{\TITLE}{+}{ }]{\grau{stets aktuelle Fassungen: \url{https://github.com/rsling/VL-Statistik}}}
\else
  \date[Kompletter Foliensatz]{\grau{stets aktuelle Fassungen: \url{https://github.com/rsling/VL-Statistik}}}
\fi
...
\else
  ...
  \let\woopsi\section\let\section\subsection\let\subsection\subsubsection
  \input{includes/03.+z-Test+und+t-Test.tex}
  \let\subsection\section\let\section\woopsi
  ...
  \let\woopsi\section\let\section\subsection\let\subsection\subsubsection
  \input{includes/06.+Nichtparametrische+Verfahren.tex}
  \let\subsection\section\let\section\woopsi
  ...
  \let\woopsi\section\let\section\subsection\let\subsection\subsubsection
  \input{includes/08.+Power+und+Severity.tex}
  \let\subsection\section\let\section\woopsi

  \section{Lineare Modelle}
  \let\woopsi\section\let\section\subsection\let\subsection\subsubsection
  \input{includes/09.+Lineare+Modelle.tex}
  \let\subsection\section\let\section\woopsi

  \section{Generalisierte Lineare Modelle}
  \let\woopsi\section\let\section\subsection\let\subsection\subsubsection
  \input{includes/10.+Generalisierte+Lineare+Modelle.tex}
  \let\subsection\section\let\section\woopsi

  \section{Gemischte Modelle}
  \let\woopsi\section\let\section\subsection\let\subsection\subsubsection
  \input{includes/11.+Gemischte+Modelle.tex}
  \let\subsection\section\let\section\woopsi
\fi
