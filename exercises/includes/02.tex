...
\begin{enumerate}
  \item $x=[$Nom, Akk, Akk, Akk, Nom, Dat, Gen, Nom, Nom, Akk, Dat, Dat, Akk, Akk$]$\Sol{\\Modus: Akk, Median: n.\,d.}
...
\end{align}
%
Da wir noch nicht wissen, was von dem präsentierten Datensalat das Mittel ist, betrachten wir $1.96\cdot\frac{1.78}{\sqrt{79}}=0,39$. Die Differenz $5.53-5.13=0.4$ ist dazu gleich bis auf Rundungsfehler, während $5.74$ nicht in eine solche Beziehung zu den anderen Werten gesetzt werden kann. Vermutlich ist $5.74$ verschrieben zu $4.74=5.13-0.39$, und das Mittel ist tatsächlich $5.13$.}
